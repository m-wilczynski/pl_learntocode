...
Otworz teraz DevTools (F12) i sprobuj uzyc naszej testowej, **globalnej funkcji** `test()`, ktora zdefiniowalismy w pliku `site.js`. Powinnismy zobaczyc wypisane *Hello World!*.
